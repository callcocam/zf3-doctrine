...
class PostTable extends AbstractTable
{
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        $this->headers = (new HeadersConfig())
            ...
            ->add('alias',['tableAlias' => 'p','title' => 'Name'],'name')
            ->add('preview',['tableAlias' => 'p','title' => 'Name'],'alias')
            ->add('cover',['tableAlias' => 'p','title' => 'Name'],'preview')
            ->add('description',['tableAlias' => 'p','title' => 'Name'],'cover')
            ->add('categorie',['tableAlias' => 'p','title' => 'Name'],'description','name')
            ->add('author',['tableAlias' => 'p','title' => 'Name'],'categorie','firstName')
